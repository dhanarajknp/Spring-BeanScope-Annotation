package com.javasampleapproach.scopeannotation.SpringBeanScopeAnnotation.WebController;
...
public class AspectLog implements ThrowsAdvice {
    ...
    @Pointcut("execution(* com.javasampleapproach.scopeannotation.*.*(..))")
    public void controller() {
    }
    @Pointcut("execution(* com.javasampleapproach.scopeannotation.*.*(..))")
    protected void allMethod() {
    }
    @Before("execution(* com.javasampleapproach.scopeannotation.*.*(..))")
